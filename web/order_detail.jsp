                        ...
                        <div class="m-l-25 m-r--38 m-lr-0-xl">
                            <div class="wrap-table-shopping-cart">
                                <table class="table-shopping-cart">
                                    ...
                                    <c:forEach var="o" items="${odl}">
                                        <tr class="table_row">
                                            <td class="column-1">${o.orderId}</td>
                                            <td class="column-2"><a href="ProductDetails?pid=${o.product.id}">${o.product.name}</a></td>
                                            <td class="column-1">
                                                <div class="how-itemcart1">
                                                    <img src="${o.product.img}" alt="IMG">
                                                </div>
                                            </td>
                                            <td class="column-2">$ ${o.price}</td>
                                            <td class="column-3">${o.quantity}</td>
                                        </tr>
                                    </c:forEach>
                            ...
                            <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                                <div class="flex-w flex-m m-r-20 m-tb-5">
                                    <input class="stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5" type="text" name="notes" placeholder="Input note ...">
