                                    ...
                                    <c:forEach var="cart" items="${sessionScope['cart'].getItems()}">
                                        ...
                                        <td class="column-1">
                                            <div class="how-itemcart1">
                                                <img src="${cart.getProduct().getImg()}" alt="IMG">
                                            </div>
                                        </td>
                                        <td class="column-2">${cart.getProduct().getName()}</td>
                                        <td class="column-3">$ ${cart.getProduct().getPrice()}</td>
                                        <td class="column-4">
                                        ...
                                        <td class="column-5">$ ${cart.getProduct().getPrice()*cart.getQuantity()}</td>
                                        <td class="column-6">
                                                    <div class="action">
