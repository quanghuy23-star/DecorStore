    ...
    <body class="animsition">
        ...
        <section class="section-slide">
            <div class="wrap-slick1">
                <div class="slick1">
                    <div class="item-slick1" style="background-image: url(./images/banner-06.jpg) ;">
                    ...
                    <div class="item-slick1" style="background-image: url(./images/banner-08.jpg);">
                        <div class="container h-full">
                            <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        ...
                        <div class="col-md-2 p-b-30">
                            <div class="block1 wrap-pic-w">
                                <div class="position-relative">
                                    <img src="${o.image}" style="height: 10rem;" alt="IMG-BANNER">
                                    <div class="block1-txt position-absolute bottom-0 w-100 p-3 bg-black text-white">
                                        <span class="block1-name ltext-102 trans-04 p-b-8">
                                            ${o.name}
                                        </span>
                                        <span class="block1-info stext-102 trans-04">
